...
export default function AdminsHeader({ stats, onAddClick }: AdminsHeaderProps) {
  return (
    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
      <div>
        ...
        <h1 className="text-3xl font-extrabold uppercase text-[#111111] leading-tight">
          Quản Lý <mark className="bg-[#03AED2] text-white px-2 py-0.5">Tài Khoản Admin</mark>
        </h1>
        <p className="mt-1 text-sm text-[#555]">
          {stats
            ? `${stats.admins} admin · ${stats.active} active · ${stats.inactive} inactive`
            : "Đang tải..."}
        </p>
      </div>
      <button
