...
interface DeleteStaticPageModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  pageTitle?: string;
...
export default function DeleteStaticPageModal({
  isOpen,
  onClose,
  onConfirm,
  pageTitle,
}: DeleteStaticPageModalProps) {
