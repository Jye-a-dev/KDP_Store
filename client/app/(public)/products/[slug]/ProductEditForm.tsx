...
import Product3dConfig from "./Product3dConfig";
import ProductSecondhandConfig from "./ProductSecondhandConfig";
...
export default function ProductEditForm({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Model 3D URL */}
      <Product3dConfig
        editModel3dUrl={editModel3dUrl}
        setEditModel3dUrl={setEditModel3dUrl}
        token={token}
        apiUrl={API_URL}
      />
